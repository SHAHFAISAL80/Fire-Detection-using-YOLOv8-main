...
video_paused = False
path1 = r"C:\Users\Atif Traders\Videos\pro\Fire-Detection-using-YOLOv8-main\models\bestfire.pt"
model = YOLO(path1)
...
def selectmodel(*args):
    ...
    model = YOLO(path1)
    if name == "bestfire":
        class_list = read_classes_from_file(r'C:\Users\Atif Traders\Videos\pro\Fire-Detection-using-YOLOv8-main\fireSmoke.txt')
    else:
        class_list = read_classes_from_file(r'C:\Users\Atif Traders\Videos\pro\Fire-Detection-using-YOLOv8-main\coco.txt')
...
root.iconbitmap(r'C:\Users\Atif Traders\Videos\pro\Fire-Detection-using-YOLOv8-main\icon.ico')
root.wm_iconbitmap(r'C:\Users\Atif Traders\Videos\pro\Fire-Detection-using-YOLOv8-main\icon.ico')
...
model_list = read_classes_from_file(r'C:\Users\Atif Traders\Videos\pro\Fire-Detection-using-YOLOv8-main\modelslist.txt')
...
initial_image = Image.open(r'C:\Users\Atif Traders\Videos\pro\Fire-Detection-using-YOLOv8-main\background.jpg')  # Replace 'background.jpg' with your image path
